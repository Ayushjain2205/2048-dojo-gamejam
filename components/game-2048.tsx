            ...
            <div className="flex gap-3">
              {account && (
                <>
                  <button
                    onClick={initGame}
                    className="bg-[#8f7a66] text-white rounded-md font-bold hover:bg-[#9f8a76] transition-colors flex justify-center items-center w-12 h-12"
                  >
                    <svg
                      className="w-6 h-6"
                      fill="none"
                  ...
                  <button
                    onClick={() => disconnect()}
                    className="group bg-[#f67c5f] text-white px-3 h-12 rounded-md font-bold transition-colors flex items-center justify-center text-sm hover:bg-red-500 flex-grow"
                  >
